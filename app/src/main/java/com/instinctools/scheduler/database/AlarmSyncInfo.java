 ...
 */
@Table(databaseName = Database.NAME, tableName = "AlarmSyncTable", insertConflict = ConflictAction.REPLACE)
public class AlarmSyncInfo extends BaseModel implements SyncInfo {
